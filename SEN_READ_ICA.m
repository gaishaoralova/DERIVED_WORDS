...
%% 5- Split the sentences into 4 conditions (high_freq-high_lsa, high-freq-low_lsa, low_freq-low_lsa, low_freq-high_lsa) 
...
EEG = convertSenIdToCondSentRead(EEG, high_freq_high_lsa, high_freq_low_lsa,low_freq_high_lsa,low_freq_low_lsa);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);


%% 7- For each of the above conditions, slice at sentence id, slice at invboundary, slice at first fixation (0-100ms)
